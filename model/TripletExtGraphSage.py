...
from layer.Net import GraphSage
...
class TripletExtGraphSage(BertPreTrainedModel):
    ...
    def _forward_train(self, encodings: torch.tensor, context_masks: torch.tensor, entity_masks: torch.tensor,
        ...
        h_graph_sage, pool_mask = self.graph_sage(adj, h)
        h = h + h_graph_sage
